...
def metadata_with_deeply_nested_attributes():
    return json.load(
        open(f"{good_json_dir}/metadata_with_deeply_nested_attributes.json", "r")
    )
...
def single_incidence_with_direction_not_in_enum():
    return json.load(
        open(f"{bad_json_dir}/single_incidence_with_direction_not_in_enum.json", "r")
    )
...
def missing_required_fields_with_direction():
    ...
    return json.load(
        open(f"{bad_json_dir}/missing_required_fields_with_direction.json", "r")
    )
